...
(function($) {
  ...
  $("a").on('click', function(event) {
    ...
    $(".photo").backstretch("img/bg.png");    
    $(".photo-centered").backstretch("img/bg.png");
    ...
    $("#words").wordsrotator({
      ...
      words: ['Build faster and awesome websites','Understand every step of the way','Unlock insights for everything']  //Array of words, it may contain HTML values
    });
